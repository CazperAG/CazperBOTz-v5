...
global.sgh = 'https://github.com/CazperAG/' // github
...
global.povo = '08886529913' //ovo
global.pgopay = '--' //gopay
global.plinkaja = '--' //link aja
global.ppulsa = '08886529913' //telkomsel
global.ppulsa2 = '08886529913' // kalau ada kartu lain isi aja
global.psaweria = '--'

/*============== NOMOR ==============*/
global.nomorbot = '628886529913'
global.nomorown = '62895325418826'
global.namebot = 'CazperBOTz-V5'
global.nameown = 'Casper Agario'

/*============== Github Thanks To ==============*/
global.namagithub = 'CazperAG' // nama github lu
...
/*============== STAFF ==============*/
global.owner = [
  ['62895325418826', 'Casper Agario', true],
  ['-', 'ISI KALAU ADA', true],
  ['-', 'ISI KALAU ADA', true],
  ['-', 'ISI KALAU ADA', true],
  ['-', 'ISI KALAU ADA', true]
...
/*============== WATERMARK ==============*/
global.wm = '                「 CazperBOTz-V5 」' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘CazperBOTz-V5 ˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = "⫹⫺ CazperBOTz-V5"
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ TIME: ${wktuwib}`
global.bottime = `T I M E : ${wktuwib}`
global.titlebot = `⫹⫺ WhatsApp Bot | By CazperAG`
global.packname = '☂︎ ᴄʀᴇᴀᴛᴇᴅ ʙʏ'
global.author = "Casper Agario 乂 CazperBOTz"
...
global.fla = 'https://i.ibb.co/XtMz7s1/thumbnail.jpg'
...
/*============== STICKER WM ==============*/
global.stickpack = 'CazperBOTz-V5'
global.stickauth = `By ©CazperAG`
